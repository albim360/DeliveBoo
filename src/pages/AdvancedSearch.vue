    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="search-sidebar">
          ...
          <input class="name-search form-control" @keyup="filterRestaurants" v-model="searchQuery" type="text"
            name="rest-name">

          <div class="typology-list">
            <div class="typology-item" v-for="typology in sortedTypologies" :key="typology.slug">
              <input class="typology-checkbox" type="checkbox" :value="typology.id" :id="typology.slug"
      ...
      <div class="col-lg-8">
        <div class="search-results">
          ...
          <ul class="restaurants-list list-group">
            <li class="list-group-item" v-for="restaurant in filteredRestaurants" :key="restaurant.id"
              @click="handleRestaurantClick(restaurant)">
              <div class="row">
                <div class="col-8 col-md-9">
                  <h4>{{ restaurant.company_name }}</h4>
                  <div class="cuisine-types">
                    <span class="badge bg-primary text-light" v-for="type in restaurant.typologies" :key="type">{{
                      type.slug }}</span>
                  </div>
                </div>
              </div>
